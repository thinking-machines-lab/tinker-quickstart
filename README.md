...
- **Update reward aggregation**: Change the way that `reward` combines the judge grade and the e-rate penalty. Right now it's just a direct sum, but maybe there's some other combination that makes more sense!
